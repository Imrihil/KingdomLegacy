...
public record StickerTypeDetails(StickerType Type, int Width, int Height, string Name)
{
    ...
    public static readonly StickerTypeDetails Sword = new(StickerType.Sword, 54, 57, "sword");
    ...
    public static readonly StickerTypeDetails Points2 = new(StickerType.Points2, 50, 72, "points2");
    public static readonly StickerTypeDetails Points5 = new(StickerType.Points5, 50, 72, "points5");
    public static readonly StickerTypeDetails Points = new(StickerType.Points, 50, 72, "points");
